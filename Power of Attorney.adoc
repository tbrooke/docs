...
COUNTY OF ROWAN			        )  	DURABLE GENERAL
           ...
           KNOW ALL MEN BY THESE PRESENTS, that I, {grantor}, the undersigned, a resident of {county} County, North Carolina, ­hereby make, constitute, and appoint {aif} in Fact
 of {aif county] County, North Carolina,  as  my true and lawful Attorney­-in-Fact for me and in my name, place and stead for the purposes hereinafter set out.  
